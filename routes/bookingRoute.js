...
router
  .route("/booking/:id")
  .put(isAuthenticatedUser, authorizedRole("admin"), updateBooking)
  .get(isAuthenticatedUser, authorizedRole("admin"), getBookingDetails);
router
  .route("/bookings")
  .get(isAuthenticatedUser, authorizedRole("admin"), getAllBookings);
